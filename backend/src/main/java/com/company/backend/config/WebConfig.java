...
public class WebConfig implements WebMvcConfigurer {
         ...
         * 这对于前端能够正确显示员工照片和下载员工简历非常重要。通过使用 UploadProperties 获取配置的目录路径，并将其转换为绝对路径和
         * URI，确保了资源能够被正确访问。
         * 日本語訳：静的リソースハンドラーを設定し、/staff_photo/** および /staff_file/**
         * へのリクエストがサーバー上のファイルシステムのパスに正しくマッピングされるようにします。
